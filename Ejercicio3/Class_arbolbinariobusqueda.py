from Class_nodo import NodoArbol
...
class ArbolBinarioBusqueda:
    ...
    def recorrido_inorden_no_recursivo(self):
        ...
        while True:
            # Recorrer hacia la izquierda y apilar todos los nodos
            if nodo_actual is not None:
                ...
                print(nodo_actual.clave, nodo_actual.cargaUtil)  # Visitar el nodo
                nodo_actual = nodo_actual.hijoDerecho  # Recorrer hacia la derecha